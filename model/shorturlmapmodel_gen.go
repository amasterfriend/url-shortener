...
var (
	...
	cacheTestdbShortUrlMapIdPrefix   = "cache:testdb:shortUrlMap:id:"
	cacheTestdbShortUrlMapMd5Prefix  = "cache:testdb:shortUrlMap:md5:"
	cacheTestdbShortUrlMapSurlPrefix = "cache:testdb:shortUrlMap:surl:"
)
...
func (m *defaultShortUrlMapModel) Delete(ctx context.Context, id uint64) error {
	...
	testdbShortUrlMapIdKey := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapIdPrefix, id)
	testdbShortUrlMapMd5Key := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapMd5Prefix, data.Md5)
	testdbShortUrlMapSurlKey := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapSurlPrefix, data.Surl)
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("delete from %s where `id` = ?", m.table)
		return conn.ExecCtx(ctx, query, id)
	}, testdbShortUrlMapIdKey, testdbShortUrlMapMd5Key, testdbShortUrlMapSurlKey)
	return err
}
...
func (m *defaultShortUrlMapModel) FindOne(ctx context.Context, id uint64) (*ShortUrlMap, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, testdbShortUrlMapIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultShortUrlMapModel) FindOneByMd5(ctx context.Context, md5 sql.NullString) (*ShortUrlMap, error) {
	testdbShortUrlMapMd5Key := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapMd5Prefix, md5)
	var resp ShortUrlMap
	err := m.QueryRowIndexCtx(ctx, &resp, testdbShortUrlMapMd5Key, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultShortUrlMapModel) FindOneBySurl(ctx context.Context, surl sql.NullString) (*ShortUrlMap, error) {
	testdbShortUrlMapSurlKey := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapSurlPrefix, surl)
	var resp ShortUrlMap
	err := m.QueryRowIndexCtx(ctx, &resp, testdbShortUrlMapSurlKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultShortUrlMapModel) Insert(ctx context.Context, data *ShortUrlMap) (sql.Result, error) {
	testdbShortUrlMapIdKey := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapIdPrefix, data.Id)
	testdbShortUrlMapMd5Key := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapMd5Prefix, data.Md5)
	testdbShortUrlMapSurlKey := fmt.Sprintf("%s%v", cacheTestdbShortUrlMapSurlPrefix, data.Surl)
...
func (m *defaultShortUrlMapModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheTestdbShortUrlMapIdPrefix, primary)
}
